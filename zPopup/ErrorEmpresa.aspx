<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ErrorEmpresa.aspx.cs" Inherits="zPopup_Error" %>
...
<body>
    ...
    <div id="banner" style="position: absolute; height: 95px; width: 475px; top: 120px;
        ...
        <asp:Label ID="Label2" runat="server" Font-Names="Arial" 
            Text="Debes de elegir primero la empresa con la que bas a trabajar" 
