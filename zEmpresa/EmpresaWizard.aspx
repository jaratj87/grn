<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmpresaWizard.aspx.cs" EnableEventValidation="true" Inherits="test_Default" %>
<!DOCTYPE html>
<html lang="es">
<head runat="server">
...
<body>
    <div id="wrapper">
        ...
        <div class="container-solo">
            <form id="registroempresa" runat="server">
              <asp:ScriptManager id="ScriptManager1" runat="server"></asp:ScriptManager>
              <div id="DivmensajeError">
                  <asp:Label id="LbErrorImagen" runat="server" ForeColor="Red"></asp:Label>
                     ...
                     <NavigationButtonStyle />
                      <WizardSteps>
                          <asp:WizardStep runat="server" Title="Bienvenido" ID="HInformacion">
                              <div id="Info">
                                  <legend>
                                      <asp:Label ID="LbTitulo" runat="server" Text="Bienvenido a la configuración de tú Factura Electrónica" />
                                  </legend>
                             </div>
                          </asp:WizardStep>
                          <asp:WizardStep ID="HPaso1" runat="server" Title="La empresa">
                              <fieldset>
                                  ...
                                  <div>
                                      <asp:Label ID="lbRfc" AssociatedControlId="txtRfc" runat="server" Text="RFC:" /> <asp:RequiredFieldValidator ID="RFVRFC" runat="server" ControlToValidate="txtRfc" ErrorMessage="Debes de capturar el RFC" CssClass="txterror">Debes de Capturar el RFC</asp:RequiredFieldValidator>
                                  ...
                                  <div>
                                      <asp:Label ID="lbEmpresa" AssociatedControlId="txtEmpresa" runat="server" Text="Nombre:" /> <asp:RequiredFieldValidator ID="RFVRFC0" runat="server" ControlToValidate="txtEmpresa" ErrorMessage="*" CssClass="txterror">Captura el nombre de la Empresa</asp:RequiredFieldValidator>
                                      <asp:TextBox runat="server" ToolTip="Nombre de la empresa" ID="txtEmpresa" />
                                  </div>
                                  <div>
                                      <asp:Label ID="lbDomicilio" AssociatedControlId="txtDomicilio" runat="server" Text="Domicilio:" /> <asp:RequiredFieldValidator ID="RFVDomicilio" runat="server" ControlToValidate="txtDomicilio" ErrorMessage="*" CssClass="txterror">Debes capturar el Domicilio</asp:RequiredFieldValidator>
                                  ...
                                  <div class="trescol">
                                      <div>
                                          ...
                                          <asp:RequiredFieldValidator ID="RFVNoExt" runat="server" ControlToValidate="txtNumExt" ErrorMessage="*" ToolTip="Debes capturar el No.Ext" CssClass="txterror">*</asp:RequiredFieldValidator>
                                      </div>  
                                      <div>
                                  ...
                                  <div>
                                      <asp:Label ID="lbClienteColonia" AssociatedControlId="txtColonia" runat="server" Text="Colonia:" /> <asp:RequiredFieldValidator ID="RFVColonia" runat="server" ControlToValidate="txtDomicilio" ErrorMessage="*" CssClass="txterror">Debes capturar la colonia</asp:RequiredFieldValidator>
                                  ...
                                  <div class="trescol">
                                      <div>
                                          ...
                                          <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtClienteMunicipio" ErrorMessage="*" ToolTip="El municipio es requerido" CssClass="txterror">*</asp:RequiredFieldValidator>
                                      </div>
                                      <div>
                                  ...
                                  <div class="doscol">
                                      ...
                                      <div class="wizmoneda">
                                          <asp:Label ID="LbMoneda" AssociatedControlId="DDmoneda" runat="server" Text="Moneda:" /> <asp:Label ID="lbClienteEstado0" runat="server" Text="(Moneda prederterminada para facturar)" CssClass="leyenda" />
                          ...
                          <asp:WizardStep ID="HPaso2" runat="server" Title="Otros datos">
                              <fieldset>
                                  ...
                                  <div>
                                      <asp:Label ID="LbCorreoElectronico" AssociatedControlId="txtCorreoElectronico" runat="server" Text="Correo electronico de la empresa:" /> <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtCorreoELectronico"
                                  ...
                                  <div class="doscol">
                                      <div>
                                          <asp:Label ID="LbTipodecambio" AssociatedControlId="txtTipoCambio" runat="server" Text="Tipo de Cambio:" /> <asp:RequiredFieldValidator ID="RFVNoExt0" runat="server" ControlToValidate="txtTipoCambio" ErrorMessage="*" CssClass="txterror">Captura el tipo de cambio</asp:RequiredFieldValidator>
