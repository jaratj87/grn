...
function ModalPopupWindow() {
    var strOverLayHTML = '<div id="divOverlay" style="position:absolute;z-index:10; background-color:#ffffff; filter: alpha(opacity = 70);opacity:0.7;"></div><div id="divFrameParent" runat = "server" style="position:absolute;z-index:12; display:none;background-color:#ffffff;border:1px solid;-moz-box-shadow: 0 0 10px 10px #BBB;-webkit-box-shadow: 0 0 10px 10px #BBB;box-shadow: 0 0 10px 10px #BBB;" class="Example_F"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr style="background-color:#de5338;"><td align="left"><span id="spanOverLayTitle" style="color:White;font-size:1em;font-family: Ubuntu, sans-serif; padding-left:10px"></span></td><td  align="right" style="height:25px;"><span id="spanOverLayWindow_Max" style="display:none" onclick="Maximisze();" style="cursor:pointer">max</span><span onclick="xxx_modalPopupWindow.HideModalPopUp();" style="cursor:pointer"> <img id="imgOverLayClose"   src="" alt="X" ></span></td></tr><tr ><td colspan="2" align="center" width="100%" id="tdOverLay"><div id="divMessage" style="margin-top:20px;display:none;"  ><span id="spanMessage" style="padding-left:40px;padding-top:10px;padding-bottom:10px; font-size:15pt;"  ></span></div><span id="spanLoading"> <img id="imgOverLayLoading" src="" alt="Loading..." /></span><iframe name="overlay_frame" id="overlay_frame" src="/Blank.htm" frameborder="0" scrolling="auto" ></iframe> </td></tr><tr id="trOverLayBtn" ><td colspan="2" align="center" style="padding-top:20px;padding-bottom:10px;"><input type="button" id="btnOverLay1" onclick="xxx_modalPopupWindow.HideModalPopUp()" value="Ok" /><input type="button" id="btnOverLay2" onclick="xxx_modalPopupWindow.HideModalPopUp()" value="Cancelar" /> </td></tr></table></div>'
    var orginalHeight;
    var orginalWidth;
    var btnStyle="";
    var maximize = false;
